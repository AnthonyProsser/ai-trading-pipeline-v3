...
- Source: conversation 2026-07-09 (user-approved roadmap, `experiments/idea_search/VOL_PIVOT_SPEC.md`), branch `pivot-vol-01` off `main` (not yet merged — auditors not yet run).
