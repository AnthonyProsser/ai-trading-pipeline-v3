...
def build_fold_loaders(
    ...
    *,
    ...
    # Targets stay OHLCV-only (idea-01-timefeatures: features carries 4 extra clock
    # columns as model INPUT, but the model only ever predicts NUM_OUTPUT_DIMS dims).
