...
def build_fold_loaders(
    ...
    *,
    ...
    # Targets stay OHLCV-only (idea-05-swinglevels: features carries 2 extra swing-
    # distance columns as model INPUT, but the model only ever predicts NUM_OUTPUT_DIMS
    # dims).
