...
class PatchTST(nn.Module):
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        ...
        # covers all NUM_INPUT_FEATURES (idea-02-multiscale: RevIN applies to every
        # input, including the 4 multi-scale momentum columns), so it's sliced to the
        # OHLCV prefix here to match y_norm's NUM_OUTPUT_DIMS.
